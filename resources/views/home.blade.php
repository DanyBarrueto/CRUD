                        ...
                        <form class="col-md-8" action="{{route("example-app.create2")}}" method="post" style="width: 200vh;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="gpu" name="gpu" class="form-control border-dark text-white" required />
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" id="anydesk" name="anydesk" class="form-control border-dark text-white"  required />
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" id="clave_equipo" name="clave_equipo" class="form-control border-dark text-white" required />
                                </div>
